 ...
 */
public class MergeKSortedListsPriorityQueueTest {

    private MergeKSortedListsIncrementalMerge mergeKSortedLists;

    @BeforeClass
    public void setUp() {

        mergeKSortedLists = new MergeKSortedListsIncrementalMerge();
    }
