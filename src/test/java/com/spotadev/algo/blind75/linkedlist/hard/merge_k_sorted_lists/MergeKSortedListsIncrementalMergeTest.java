 ...
 */
public class MergeKSortedListsIncrementalMergeTest {

    private MergeKSortedListsPriorityQueue mergeKSortedLists;

    @BeforeClass
    public void setUp() {

        mergeKSortedLists = new MergeKSortedListsPriorityQueue();
    }
