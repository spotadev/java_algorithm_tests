...
import com.spotadev.algo.blind75.linkedlist.easy.merge_two_lists.ListNode;
import com.spotadev.algo.blind75.linkedlist.easy.merge_two_lists.MergeTwoListsAlt;

/**
 * @author John Dickerson - 17 Apr 2022
 */
public class MergeTwoListsAltTest {

    private MergeTwoListsAlt mergeTwoLists;

    @BeforeClass
    public void setUp() {

        mergeTwoLists = new MergeTwoListsAlt();
    }
