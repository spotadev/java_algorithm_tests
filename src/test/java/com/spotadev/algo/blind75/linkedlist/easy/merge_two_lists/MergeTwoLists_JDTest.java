...
import com.spotadev.algo.blind75.linkedlist.easy.merge_two_lists.MergeTwoLists_JD;

/**
 * @author John Dickerson - 17 Apr 2022
 */
public class MergeTwoLists_JDTest {

    private MergeTwoListsAPI mergeTwoLists;

    @BeforeClass
    public void setUp() {

        mergeTwoLists = new MergeTwoLists_JD();
    }
