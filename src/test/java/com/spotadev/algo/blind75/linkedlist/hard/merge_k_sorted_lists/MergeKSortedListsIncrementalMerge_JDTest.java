 ...
 */
public class MergeKSortedListsIncrementalMerge_JDTest {

    private MergeKSortedListsPriorityQueue_JD mergeKSortedLists;

    @BeforeClass
    public void setUp() {

        mergeKSortedLists = new MergeKSortedListsPriorityQueue_JD();
    }
