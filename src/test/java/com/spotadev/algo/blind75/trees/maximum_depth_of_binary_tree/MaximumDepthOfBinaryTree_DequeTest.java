 ...
 */
public class MaximumDepthOfBinaryTree_DequeTest {

    private MaximumDepthOfBinaryTree_RecursiveUsingMax maximumDepthOfBinaryTree;

    @BeforeClass
    public void setUp() {

        maximumDepthOfBinaryTree = new MaximumDepthOfBinaryTree_RecursiveUsingMax();
    }
