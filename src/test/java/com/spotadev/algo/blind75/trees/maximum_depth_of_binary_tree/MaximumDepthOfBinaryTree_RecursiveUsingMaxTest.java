 ...
 */
public class MaximumDepthOfBinaryTree_RecursiveUsingMaxTest {

    private MaximumDepthOfBinaryTree_Deque maximumDepthOfBinaryTree;

    @BeforeClass
    public void setUp() {

        maximumDepthOfBinaryTree = new MaximumDepthOfBinaryTree_Deque();
    }
