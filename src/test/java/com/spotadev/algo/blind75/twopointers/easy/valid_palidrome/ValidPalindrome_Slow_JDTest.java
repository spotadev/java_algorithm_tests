...
import com.spotadev.algo.blind75.twopointers.easy.valid_palidrome.ValidPalindrome_Slow_JD;

/**
 * @author John Dickerson - 2 May 2022
 */
public class ValidPalindrome_Slow_JDTest {

    private ValidPalindrome_Slow_JD validPalindrome;

    @BeforeClass
    public void setUp() {

        validPalindrome = new ValidPalindrome_Slow_JD();
    }
