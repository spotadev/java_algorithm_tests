...
import com.spotadev.algo.easy.reversearray.ReverseArray;
...
public class ReverseArrayTest {
    ...
    public void reverseTest() {
        ...
        String[] inData = 
                new String[]{ "Reversing", "an", "Array", "is", "easy", "when", "you", "know", "how." };
        
        String[] outData = new String[ inData.length ];
        String[] expected = { "how.",  "know", "you", "when", "easy", "is", "Array", "an", "Reversing" };
