 ...
 * your quick sort works. Print both unsorted and sorted array to the console.
 * 
 ...
 *    3. Pivot elements are again picked from the items on the right and those on the left of the original pivot element
 *       and procedure 2 is repeated again till the array is sorted.
 *       
 ...
 *                  [ 14, 21, 5, (62), 1, 12, 7 ]
 *                  
 *  Step 2 : comparing the other elements placing smaller to the left and greater to the right of the pivot
 *          i.e
 *          
 *                  [ 14, 21, 5, 1, (62), 12, 7 ]
 *                  
 *          here, going through the array from 14, 14, 21 and 5 are all smaller than 62 hence they remain on the left
 ...
 *                  [ 14, 21, (5), 1, 12, 7 ]
 *                  
 *          here we start with 14 being the primary pivot element for 5 (as it is the first greater element than 5 on the left)
 ...
 *  
 *  Worst case occurs when the pivot element picked is either the greatest ( as in the beginning above) or the smallest element.
 ...
 *  
 *  Best case occurs when the pivot element is always the middle element
 *  hence a time complexity of O(n*log n)
 *           
