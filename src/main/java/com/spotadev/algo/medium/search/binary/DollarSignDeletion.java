 ...
 * Each of the strings is run through a method to operate on the $ DELETE action. We want to find out if the final string is
 * the same for all of them. For example:
 *
 * EXAMPLES:
 * input --> ["f$st", "st"]
