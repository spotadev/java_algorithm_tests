 ...
 * 2. Divides the sublists again to smaller sublists until there are single elements in each collection.
 ...
 *  { 5 } { 89 } { 62 } { 34 } { 17 } { 28 } { 46 }
 *  
 *  the single elements are then merged back to their respective sublists when sorted 
