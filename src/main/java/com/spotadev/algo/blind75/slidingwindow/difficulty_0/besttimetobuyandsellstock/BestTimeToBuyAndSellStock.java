/*
    ...
    ================================================================================================
*/
package com.spotadev.algo.blind75.slidingwindow.difficulty_0.besttimetobuyandsellstock;
...
public class BestTimeToBuyAndSellStock {
    ...
    public int maxProfit( int[] prices ) {
        ...
        while ( leftIndex < prices.length - 1 && rightIndex < prices.length ) {

            int leftPrice = prices[leftIndex];
            int rightPrice = prices[rightIndex];
