 ...
 * 
 *    2. All elements that are smaller than the pivot are placed to it's left while all elements 
 *       that are greater are placed to it's right. (This is for ascending order)
 *    
 ...
 *          remain on the left 1 is swapped with 62 to come to it's left as it is smaller.
 *          
 *          hence:
 *          
 *                  [ 14, 21, 5, 1, 12, (62), 7 ]
 ...
 *          element than 5 on the left) meaning it will be swapped with first number that is less 
 *          than 5
 *          
 *          i.e
 *                  [ 1, 21, (5), 14, 12, 7 ]
 ...
 *                  [ 1, (5), 21, 14, 12, 7 ]
 *           
 *           Since the left side of 5 is already sorted no swapping will occur we move to it's right 
 *           side and choose a pivot e.g 14
 *           
 *           i.e
 *                  [ 21, (14), 12, 7 ]
 *                  
 ...
 *  
 *  Best case occurs when the pivot element is always the middle element hence a time complexity of 
 *  O(n*log n)
 *           
 *  NB: Pivot elements chosen can be at the middle but still be the greatest elements hence a worst 
 *  case situation of the algorithm.
 *
 ...
 */
public class QuickSort_KM implements QuickSortAPI {
