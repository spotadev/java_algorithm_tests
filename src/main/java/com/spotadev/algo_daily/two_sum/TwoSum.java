...
/**
 * PROBLEM STATEMENT:
 * Given an array of integers, return the indices of the two numbers that add up to a specific given target number.
 * Given an array e.g. [1, 3, 6, 7, 9] and a target number say 10. Two numbers that add up to ten in the array and their
 * indices respectively are [1 and 9] at indices 0 and 5.
 *
 * EXAMPLES:
